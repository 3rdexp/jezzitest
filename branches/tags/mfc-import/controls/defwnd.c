Go To Google Code Search Home		This is Google's cached copy of wine-20050111/windows/defwnd.c from
http://gentoo.osuosl.org/distfiles/Wine-20050111.tar.gz

Search matches are highlighted:  lang:^(c|c#|c\+\+)$ NC_HandleNCCalcSize

Type n or p to move to the next or previous match.

Google is neither affiliated with the authors of this page nor responsible for its content.

http://gentoo.osuosl.org/distfiles/Wine-20050111.tar.gz/wine-20050111/windows/
...
wine-20050111/windows/defwnd.c from
http://gentoo.osuosl.org/distfiles/Wine-20050111.tar.gz
