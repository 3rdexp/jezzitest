...
<h2>How to use LyoulHttpClient</h2>

<p>
In your project, include the following files.
<ul>
    <li> LyoulException.h
    <li> LyoulException.cpp
    <li> LyoulHttpClient.h
    <li> LyoulHttpClient.cpp
    <li> SafeInt.hpp
</ul>
...
try {
    ...
    objHttpReq.AddHeader (_T ("Lyoul-Magic"), _T ("My Magic Header")) ;
...
public:
    // Returns the last error code. The error codes is defined in LyoulHttpClient.h
...
#include "LyoulException.h"		// for exception classes
...
public:
	...
	static inline LPSTR StringChr (LPCSTR szStr, int Chr) throw ()
	{
		return ::strchr (szStr, Chr) ;
	}

	static inline LPSTR StringRChr (LPCSTR szStr, int Chr) throw ()
	{
	...
	static PSTR StringStr (PCSTR szString, PCSTR szSearch) throw ()
	{
	...
	static HANDLE OpenFile (LPCSTR szFilePath) throw () ;
...
public:
	...
	static inline LPWSTR StringChr (LPCWSTR szStr, WCHAR Chr) throw ()
	{
		return ::wcschr (szStr, Chr) ;
	}

	static inline LPWSTR StringRChr (LPCWSTR szStr, WCHAR Chr) throw ()
	{
	...
	static PWSTR StringStr (PCWSTR szString, PCWSTR szSearch) throw ()
	{
	...
	static void InternetWriteFile (HINTERNET hRequest, const BYTE * pbyBuff, DWORD cbyBuff) throw (Exception &) ;
	static void EndRequest (HINTERNET hRequest) throw (Exception &) ;
	static HANDLE OpenFile (LPCWSTR szFilePath) throw () ;
...
public:
	...
	BOOL Remove (PCSZ szName, DWORD nIdx = 0) throw () ;

	BOOL Exists (PCSZ szName, DWORD nIdx = 0) throw () ;
	DWORD Count (PCSZ szName = NULL) throw () ;
	BOOL Empty (void) const throw () ;

	PCSZ GetKey (DWORD nIdx) throw () ;

	MapValue Get (DWORD nIdx) throw () ;
...
public:
	...
	/*! \brief	Returns the number of bytes required to make an UTF-8 string from a string. */
	...
	/*! \brief	Returns the number of bytes required to make a string from an UTF-8 string. */
	...
	/*! \brief	Returns the number of bytes required to make a URL-encoded string from an Ansi string. */
	static DWORD UrlEncodeLenA (PCSTR szStr, BOOL bUtf8Encoding = FALSE, UINT CodePage = CP_ACP) throw (Exception &) ;
	/*!
	 * \brief	Returns the number of unicode characters required to make a URL-encoded string from an Ansi string.
	 *
	...
	/*! \brief	Decodes an URL-encoded string to make a string. */
...
public:
	...
	/*! \brief	Returns the number of bytes required to make a URL-encoded string from an Unicode string. */
	static DWORD UrlEncodeLenA (PCWSTR szStr, BOOL bUtf8Encoding = FALSE, UINT CodePage = CP_ACP) throw (Exception &) ;
	/*!
	 * \brief	Returns the number of unicode characters required to make a URL-encoded string from an Unicode string.
	 *
	 * This method returns the number of unicode characters required to make a URL-encoded string
...
///////////////////////////////////////// CHttpResponseT /////////////////////////////////////////
/*!
 * \brief	This class represents the response returned by the HTTP server.
 *
 * It represents the data stream returned by the HTTP server. This class is
 * returned by the methods of the CHttpClientT class if the HTTP request succeeds.
 *
...
public:
	...
	/*! \brief	Returns the number of headers of which name is the szName */
	DWORD GetHeaderCount (PCSZ szName) throw (Exception &) ;
	/*! \brief	Returns the header of which name is the szName */
	PCSZ GetHeader (PCSZ szName, DWORD nIdx = 0) throw (Exception &) ;	

	/*! \brief	Returns the HTTP status code returned by a HTTP server */
	DWORD GetStatus (void) throw (Exception &) ;
	/*! \brief	Returns the HTTP status text returned by a HTTP server */
	PCSZ GetStatusText (void) throw (Exception &) ;
	/*! \brief	Retrieves the length of the content returned by a HTTP server */
	BOOL GetContentLength (DWORD & cbContLen) throw (Exception &) ;
	/*! \brief	Reads the content returned by a HTTP server */
 ...
 *
 * The purpose of this class is to provide progress information for user.
 * If you call BeginPost method or BeginUpload method of the CHttpClient class, you can retrieve
 * progress information using Query method of the CHttpClient class.
 *
...
public:
	...
	/*! \brief	Returns the actual total number of bytes of the request */
	size_t ActualTotalByte (void) const throw () ;
	/*! \brief	Returns the actual number of posted bytes of the request */
	size_t ActualPostedByte (void) const throw () ;

	/*! \brief	Returns the total number of bytes of the request */
	size_t TotalByte (void) const throw () ;
	/*! \brief	Returns the number of posted bytes of the request */
	size_t PostedByte (void) const throw () ;

	/*! \brief	Returns the total number of parameters */
	DWORD TotalCount (void) const throw () ;
	/*! \brief	Returns the number of posted parameters */
	DWORD PostedCount (void) const throw () ;
	/*! \brief	Returns the number of file parameters */
	DWORD FileCount (void) const throw () ;
	/*! \brief	Returns the number of posted file parameters */
	DWORD PostedFileCount (void) const throw () ;

	/*! \brief	Returns the name of the current parameter */
	PCSZ CurrParam (void) const throw () ;
	/*! \brief	Returns the file path of the current parameter */
	PCSZ CurrFile (void) const throw () ;
	/*! \brief	Returns the total number of bytes of the current parameter */
	size_t CurrParamTotalByte (void) const throw () ;
	/*! \brief	Returns the number of posted bytes of the current parameter */
	size_t CurrParamPostedByte (void) const throw () ;
	/*! \brief	Returns the number of remained bytes of the current parameter */
	size_t CurrParamRemainByte (void) const throw () ;
	/*! \brief	Returns TRUE if the current parameter is a file parameter */
	BOOL CurrParamIsFile (void) const throw () ;
	/*! \brief	Returns TRUE if the current parameter is completly posted. */
	BOOL CurrParamIsComplete (void) const throw () ;
...
public:
	...
	/*! \brief	Returns the index of the protocol in the URL
	 *
	 * This method returns the index of the protocol in the URL.
	 *
	 * \return		The index of the protocol.
	 */
	inline DWORD ProtocolIdx (void) const throw () { return m_nProtocolIdx ; }
	/*! \brief	Returns the length of the protocol in the URL
	 *
	 * This method returns the length of the protocol in the URL.
	 *
	 * \return		The length of the protocol.
	 */
	inline DWORD ProtocolLen (void) const throw () { return m_cchProtocol ; }
	/*! \brief	Returns the index of the server address in the URL
	 *
	 * This method returns the index of the server address in the URL.
	 *
	 * \return		The index of the server address.
	 */
	inline DWORD AddressIdx (void) const throw () { return m_nServerAddrIdx ; }
	/*! \brief	Returns the length of the server address in the URL
	 *
	 * This method returns the length of the server address in the URL.
	 *
	 * \return		The length of the server address.
	 */
	inline DWORD AddressLen (void) const throw () { return m_cchServerAddr ; }
	/*! \brief	Returns the index of the server port in the URL
	 *
	 * This method returns the index of the server port in the URL.
	 *
	 * \return		The index of the server port.
	 */
	inline DWORD PortIdx (void) const throw () { return m_nServerPortIdx ; }
	/*! \brief	Returns the length of the server port in the URL
	 *
	 * This method returns the length of the server port in the URL.
	 *
	 * \return		The length of the server port.
	 */
	inline DWORD PortLen (void) const throw () { return m_cchServerPort ; }
	/*! \brief	Returns the index of the path in the URL
	 *
	 * This method returns the index of the path in the URL.
	 *
	 * \return		The index of the path.
	 */
	inline DWORD PathIdx (void) const throw () { return m_nUrlPathIdx ; }
	/*! \brief	Returns the length of the path in the URL
	 *
	 * This method returns the length of the path in the URL.
	 *
	 * \return		The length of the path.
	 */
	inline DWORD PathLen (void) const throw () { return m_cchUrlPath ; }
	/*! \brief	Returns the index of the search string in the URL
	 *
	 * This method returns the index of the search string in the URL.
	 *
	 * \return		The index of the search string.
	 */
	inline DWORD SearchIdx (void) const throw () { return m_nSearchIdx ; }
	/*! \brief	Returns the length of the search string in the URL
	 *
	 * This method returns the length of the search string in the URL.
	 *
	 * \return		The length of the search string.
	 */
	inline DWORD SearchLen (void) const throw () { return m_cchSearch ; }
	/*! \brief	Returns the index of the bookmark in the URL
	 *
	 * This method returns the index of the bookmark in the URL.
	 *
	 * \return		The index of the bookmark.
	 */
	inline DWORD BookmarkIdx (void) const throw () { return m_nBookmarkIdx ; }
	/*! \brief	Returns the length of the bookmark in the URL
	 *
	 * This method returns the length of the bookmark in the URL.
	 *
	 * \return		The length of the bookmark.
	 */
...
///////////////////////////////////////// CHttpClientT /////////////////////////////////////////
/*!
 * \brief	This class helps you to interact with a HTTP server.
 *
...
public:
	...
	BOOL SetUseUtf8 (BOOL bUseUtf8) throw () ;
	/*! \brief	Returns the current UseUtf8 property */
	BOOL UseUtf8 (void) const throw () ;
	/*! \brief	Sets a code page for ANSI string */
	UINT SetAnsiCodePage (UINT nAnsiCodePage) throw () ;
	...
	/*! \brief	Erases the HTTP header at given index */
	BOOL RemoveHeader (DWORD nIdx) throw () ;
	/*! \brief	Erases the HTTP header at the specified position  */
	BOOL RemoveHeader (PCSZ szName, DWORD nIdx = 0) throw () ;
	/*! \brief	Erases all HTTP headers whose name equal to szName */
	...
	/*! \brief	Sets the HTTP header at the specified position */
	void SetHeader (PCSZ szName, PCSZ szValue, DWORD nIdx = 0) throw (Exception &) ;
	/*! \brief	Returns the name of the HTTP header at given index */
	PCSZ GetHeaderName (DWORD nIdx) throw () ;
	/*! \brief	Returns the HTTP header at the given index */
	PCSZ GetHeader (DWORD nIdx) throw () ;
	/*! \brief	Returns the HTTP header at the specified position */
	PCSZ GetHeader (PCSZ szName, DWORD nIdx = 0) throw () ;
	/*! \brief	Returns whether the HTTP header at the specified position exists */
	BOOL HeaderExists (PCSZ szName, DWORD nIdx = 0) throw () ;
	/*! \brief	Returns the number of HTTP headers of which name equals to szName */
	DWORD GetHeaderCount (PCSZ szName = NULL) throw () ;


	// Methods related to the HTTP Parameters ===========================
	/*!
	* \brief	An enum for the attributes of the HTTP parameter
	* 
	...
	*/
	enum ParamAttr
	{
		...
		, ParamEncoded		= ParamEncodedName
							| ParamEncodedValue	//!< The parameter's name and value are a URL-Encoded string.
												//!  This means that the parameter's name and value are not encoded using URL-encoding
												//!  before sending to the web server when the HTTP GET or POST is started.
	} ;

	/*! \brief	Erases all HTTP parameters */
	BOOL ClearParam (void) throw () ;
	/*! \brief	Erases the HTTP parameter at given index */
	BOOL RemoveParam (DWORD nIdx) throw () ;
	/*! \brief	Erases the HTTP parameter at the specified position  */
	BOOL RemoveParam (PCSZ szName, DWORD nIdx = 0) throw () ;
	/*! \brief	Erases all HTTP parameters whose name equal to szName */
	BOOL RemoveAllParam (PCSZ szName) throw () ;
	/*! \brief	Adds a new HTTP parameter */
	void AddParam (PCSZ szName, PCSZ szValue = NULL, DWORD dwParamAttr = ParamNormal) throw (Exception &) ;
	/*! \brief	Sets the HTTP parameter at the specified position */
	void SetParam (PCSZ szName, PCSZ szValue = NULL, DWORD dwParamAttr = ParamNormal, DWORD nIdx = 0) throw (Exception &) ;
	/*! \brief	Returns the name of the HTTP parameter at the given index */
	PCSZ GetParamName (DWORD nIdx) throw () ;
	/*! \brief	Returns the HTTP parameter at the given index */
	PCSZ GetParam (DWORD nIdx) throw () ;
	/*! \brief	Returns the HTTP parameter at the specified position */
	PCSZ GetParam (PCSZ szName, DWORD nIdx = 0) throw () ;
	/*! \brief	Returns the attribute of the HTTP parameter at the given index */
	DWORD GetParamAttr (DWORD nIdx) throw () ;
	/*! \brief	Returns the attribute of the HTTP parameter at the specified position */
	DWORD GetParamAttr (PCSZ szName, DWORD nIdx = 0) throw () ;
	/*! \brief	Returns whether the HTTP parameter at the specified position exists */
	BOOL ParamExists (PCSZ szName, DWORD nIdx = 0) throw () ;
	/*! \brief	Returns the number of HTTP parameters of which name equals to szName */
	...
	/*! \brief	Returns the number of characters required to make a URL for HTTP GET request */
	DWORD MakeGetUrlLen (PCSZ szUrl) throw (Exception &) ;
	/*! \brief	Returns a URL for HTTP GET request */
	...
	/*! \brief	Sets a proxy user name and password */
	void SetProxyAccount (PCSZ szUserName = NULL, PCSZ szPassword = NULL) throw (Exception &) ;
	/*! \brief	Returns the current proxy user name. */
	PCSZ GetProxyUserName (void) const throw () ;
	/*! \brief	Returns the current proxy password. */
...
private:
	...
	void _ReleasePostContext (HINTERNET & hInternet, HINTERNET & hConnection, HINTERNET & hRequest) throw () ;
	void _EndPostContext (void) throw () ;
} ;
